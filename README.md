...
### Description
<p> Using Vite and Netlify, deploy a static site from Github Repo.</p>
...
---
### User Story
- AAS AN employer looking for candidates with experience building single-page applications
- I WANT to view a potential employee's deployed React portfolio of work samples
- SSO THAT I can assess whether they're a good candidate for an open position
...
- Clone this repo: 'https://github.com/bobc04/Applicant-Tracker' (without quotes)
